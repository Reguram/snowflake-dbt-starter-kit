...
**Load** [network-policy-advisor/SKILL.md](network-policy-advisor/SKILL.md) for advisory workflows: recommending network policies from access history, evaluating candidate policies, and migrating existing policies to SaaS rules.
