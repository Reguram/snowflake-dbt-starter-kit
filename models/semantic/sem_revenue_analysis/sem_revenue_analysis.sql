...
AI_SQL_GENERATION 'When users ask about revenue, sales, or transactions, query this semantic view. total_revenue is the primary revenue metric - always use SUM aggregation. For time-based queries, group by sales_date. maker represents the manufacturer or brand. item_category is either Smartphone or Other.'
