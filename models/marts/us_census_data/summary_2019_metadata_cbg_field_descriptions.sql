-- Summary mart: auto-generated aggregations from 2019_METADATA_CBG_FIELD_DESCRIPTIONS
...
with source as (
    select * from {{ ref('stg_us_census_data__2019_metadata_cbg_field_descriptions') }}
)
