-- Summary mart: auto-generated aggregations from DATABANK_DEMOGRAPHICS
-- Dimensions: ISO3166_2, FIPS, STATE, COUNTY, COUNTRY_REGION
-- Measures: LATITUDE, LONGITUDE, TOTAL_POPULATION, TOTAL_MALE_POPULATION, TOTAL_FEMALE_POPULATION

with source as (
    select * from {{ ref('stg_covid19_data__databank_demographics') }}
)
...
from source
group by iso3166_2, fips, state, county, country_region
