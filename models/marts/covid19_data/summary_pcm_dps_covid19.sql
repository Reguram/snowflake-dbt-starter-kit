-- Summary mart: auto-generated aggregations from PCM_DPS_COVID19
-- Dimensions: PROVINCE_STATE, CASE_TYPE, ISO3166_1, ISO3166_2, LAST_REPORTED_FLAG
-- Measures: CASES, LONG, LAT, DIFFERENCE

with source as (
    select * from {{ ref('stg_covid19_data__pcm_dps_covid19') }}
)
...
from source
group by province_state, case_type, iso3166_1, iso3166_2, last_reported_flag, date_trunc('month', date), year(date)
