...
GRANT USAGE ON ALL SCHEMAS IN DATABASE DBT_DEV TO ROLE DBT_ROLE;
GRANT SELECT ON ALL TABLES IN DATABASE DBT_DEV TO ROLE DBT_ROLE;
GRANT SELECT ON ALL VIEWS IN DATABASE DBT_DEV TO ROLE DBT_ROLE;
GRANT SELECT ON FUTURE TABLES IN DATABASE DBT_DEV TO ROLE DBT_ROLE;
GRANT SELECT ON FUTURE VIEWS IN DATABASE DBT_DEV TO ROLE DBT_ROLE;
...
-- GRANT SELECT ON VIEW DBT_DEV.SEMANTIC.SEM_REVENUE_ANALYSIS TO ROLE DBT_ROLE;


-- ==========================================
-- 4. Grant PAT security integration to the role
-- ==========================================
-- PAT integration grant (only needed if using a security integration)
-- GRANT USAGE ON INTEGRATION DBT_MCP_PAT TO ROLE DBT_ROLE;
