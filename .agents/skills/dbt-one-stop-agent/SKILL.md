...
>
> **Skill path resolution:** Try `.agents/skills/<skill>/SKILL.md` first. If not
> found, fall back to `.snowflake/cortex/skills/<skill>/SKILL.md`.
>
...
2. For each skill in the chain: `read_file(".agents/skills/<skill>/SKILL.md")` (fallback to `.snowflake/cortex/skills/<skill>/SKILL.md`).
